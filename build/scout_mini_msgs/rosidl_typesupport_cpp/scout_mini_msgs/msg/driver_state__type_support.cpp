...
static const _DriverState_type_support_symbol_names_t _DriverState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scout_mini_msgs, msg, DriverState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, scout_mini_msgs, msg, DriverState)),
  }
};
...
{
  return &::scout_mini_msgs::msg::rosidl_typesupport_cpp::DriverState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, scout_mini_msgs, msg, DriverState)() {
  return get_message_type_support_handle<scout_mini_msgs::msg::DriverState>();
}
