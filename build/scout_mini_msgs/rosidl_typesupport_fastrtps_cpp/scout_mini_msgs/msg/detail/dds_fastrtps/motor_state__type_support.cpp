...
#include "scout_mini_msgs/msg/detail/motor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const scout_mini_msgs::msg::MotorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  scout_mini_msgs::msg::MotorState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = scout_mini_msgs::msg::MotorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const scout_mini_msgs::msg::MotorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<scout_mini_msgs::msg::MotorState *>(
    untyped_ros_message);
...
{
  return &scout_mini_msgs::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, scout_mini_msgs, msg, MotorState)() {
  return &scout_mini_msgs::msg::typesupport_fastrtps_cpp::_MotorState__handle;
}
