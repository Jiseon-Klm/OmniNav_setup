  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const scout_mini_msgs__msg__FaultState * ros_message = static_cast<const scout_mini_msgs__msg__FaultState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_scout_mini_msgs__msg__FaultState(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  scout_mini_msgs__msg__FaultState * ros_message = static_cast<scout_mini_msgs__msg__FaultState *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_scout_mini_msgs__msg__FaultState(cdr, ros_message);
}
