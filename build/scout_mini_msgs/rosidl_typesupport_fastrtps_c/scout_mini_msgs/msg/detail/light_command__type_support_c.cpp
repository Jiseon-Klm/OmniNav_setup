...
bool cdr_serialize_scout_mini_msgs__msg__LightCommand(
  const scout_mini_msgs__msg__LightCommand * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scout_mini_msgs
bool cdr_deserialize_scout_mini_msgs__msg__LightCommand(
  eprosima::fastcdr::Cdr & cdr,
  scout_mini_msgs__msg__LightCommand * ros_message)
{
  // Field name: mode
  {
    cdr >> ros_message->mode;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scout_mini_msgs
bool cdr_serialize_key_scout_mini_msgs__msg__LightCommand(
  const scout_mini_msgs__msg__LightCommand * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scout_mini_msgs
size_t get_serialized_size_key_scout_mini_msgs__msg__LightCommand(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LightCommand__ros_msg_type * ros_message = static_cast<const _LightCommand__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_scout_mini_msgs
size_t max_serialized_size_key_scout_mini_msgs__msg__LightCommand(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const scout_mini_msgs__msg__LightCommand * ros_message = static_cast<const scout_mini_msgs__msg__LightCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_scout_mini_msgs__msg__LightCommand(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  scout_mini_msgs__msg__LightCommand * ros_message = static_cast<scout_mini_msgs__msg__LightCommand *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_scout_mini_msgs__msg__LightCommand(cdr, ros_message);
}
