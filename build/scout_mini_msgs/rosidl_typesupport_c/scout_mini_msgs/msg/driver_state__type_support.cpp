...
#include "scout_mini_msgs/msg/detail/driver_state__type_support.h"
...
static const _DriverState_type_support_symbol_names_t _DriverState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, scout_mini_msgs, msg, DriverState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, scout_mini_msgs, msg, DriverState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, scout_mini_msgs, msg, DriverState)() {
  return &::scout_mini_msgs::msg::rosidl_typesupport_c::DriverState_message_type_support_handle;
}
