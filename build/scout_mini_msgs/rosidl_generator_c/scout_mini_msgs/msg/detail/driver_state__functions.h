...
// IWYU pragma: private, include "scout_mini_msgs/msg/driver_state.h"


#ifndef SCOUT_MINI_MSGS__MSG__DETAIL__DRIVER_STATE__FUNCTIONS_H_
#define SCOUT_MINI_MSGS__MSG__DETAIL__DRIVER_STATE__FUNCTIONS_H_
 ...
 * calls
 * scout_mini_msgs__msg__DriverState__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_scout_mini_msgs
scout_mini_msgs__msg__DriverState *
scout_mini_msgs__msg__DriverState__create(void);

/// Destroy msg/DriverState message.
/**
 * It calls
 * scout_mini_msgs__msg__DriverState__fini()
 ...
 * scout_mini_msgs__msg__DriverState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * scout_mini_msgs__msg__DriverState__Sequence__fini()
 * on the array,
...
#endif  // SCOUT_MINI_MSGS__MSG__DETAIL__DRIVER_STATE__FUNCTIONS_H_
