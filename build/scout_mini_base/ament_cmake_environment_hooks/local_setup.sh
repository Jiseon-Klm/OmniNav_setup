...
: ${AMENT_CURRENT_PREFIX:="/workspace/OmniNav/install/scout_mini_base"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_base/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/scout_mini_base/environment/path.sh"
