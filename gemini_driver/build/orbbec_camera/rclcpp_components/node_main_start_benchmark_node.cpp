...
#define NODE_MAIN_LOGGER_NAME "start_benchmark_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libstart_benchmark.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<orbbec_camera::tools::StartBenchmark>";
