...
#define NODE_MAIN_LOGGER_NAME "multi_save_rgbir_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmulti_save_rgbir.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<orbbec_camera::tools::MultiCameraSubscriber>";
