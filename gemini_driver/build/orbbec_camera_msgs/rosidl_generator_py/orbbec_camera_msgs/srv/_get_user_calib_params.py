...
class Metaclass_GetUserCalibParams_Event(type):
    """Metaclass of message 'GetUserCalibParams_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_user_calib_params__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_user_calib_params__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_user_calib_params__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_user_calib_params__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_user_calib_params__event
...
class GetUserCalibParams_Event(metaclass=Metaclass_GetUserCalibParams_Event):
    """Message class 'GetUserCalibParams_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<orbbec_camera_msgs/GetUserCalibParams_Request, 1>',
        'response': 'sequence<orbbec_camera_msgs/GetUserCalibParams_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetUserCalibParams_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['orbbec_camera_msgs', 'srv'], 'GetUserCalibParams_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetUserCalibParams_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetUserCalibParams_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetUserCalibParams_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from orbbec_camera_msgs.srv import GetUserCalibParams_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetUserCalibParams_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetUserCalibParams_Response'"
...
class Metaclass_GetUserCalibParams(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _get_user_calib_params.Metaclass_GetUserCalibParams_Event._TYPE_SUPPORT is None:
                _get_user_calib_params.Metaclass_GetUserCalibParams_Event.__import_type_support__()
...
class GetUserCalibParams(metaclass=Metaclass_GetUserCalibParams):
    ...
    from orbbec_camera_msgs.srv._get_user_calib_params import GetUserCalibParams_Event as Event
