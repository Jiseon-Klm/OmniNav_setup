...
static char orbbec_camera_msgs__msg__DeviceInfo__FIELD_NAME__current_sdk_version[] = "current_sdk_version";
...
static rosidl_runtime_c__type_description__Field orbbec_camera_msgs__msg__DeviceInfo__FIELDS[] = {
  ...
  {
    {orbbec_camera_msgs__msg__DeviceInfo__FIELD_NAME__current_sdk_version, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {orbbec_camera_msgs__msg__DeviceInfo__FIELDS, 7, 7},
    },
